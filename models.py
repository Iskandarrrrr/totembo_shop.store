...
class Customer(models.Model):
    ...
    first_name = models.CharField(max_length=255, verbose_name='Имя покупателья', default='')
    last_name = models.CharField(max_length=255, verbose_name='Фамилия покупателья', default='')
